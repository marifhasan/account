            ...
            <Popover class="relative bg-white">
                <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
                                ...
                                <PopoverPanel class="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                                    <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                                            <a v-for="item in solutions" :key="item.name" :href="item.href" :target="item.name" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                                ...
                                                <div class="ml-4">
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-500"> {{ item.intro }} </p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        ...
                        <a :href="route('register')" class="ml-8 whitespace-nowrap inline-flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-purple-700 hover:to-indigo-700">
                            Sign up
                        </a>
                    </div>
                </div>
                    ...
                    <PopoverPanel focus class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                            ...
                            <div class="py-6 px-5">
                                ...
                                <div class="mt-6">
                                    <a :href="route('login')" class="w-full flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-purple-700 hover:to-indigo-700">
                                        Sign up
                                    </a>
                                    <p class="mt-6 text-center text-base font-medium text-gray-500">
                                        Existing customer?
                                        <Link href="#" class="text-gray-900"> Sign in </Link>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <main>
                    ...
                    <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                        ...
                        <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                            <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                                <span class="block text-white">Modern Technologies</span >
                                <span class="block text-indigo-200">Client Support</span>
                            </h1>
                            <p class="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                                Making communication is kind of relation what we
                                believe. Only a relation can built a easy life
                                to live for everybody in this world.
                            </p>
            ...
            <div class="bg-gray-100">
                <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                        <div v-for="company in companies" :key="company.id" class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                            <a :href="company.href" target="_blank"> <img class="h-12" :src="company.image?? company.href" :alt="company.name" /> </a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                        <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                            <div>
                                ...
                                <div class="mt-6">
                                    <h2 class="text-3xl font-extrabold tracking-tight text-gray-900"> {{ branding_01.name }} </h2>
                                    <p class="mt-4 text-lg text-gray-500"> {{ branding_01.description }} </p>
                                    <div class="mt-6">
                                        <a :href="branding_01.href" :target="branding_01.name" class="inline-flex bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700">
                                            Get started
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="mt-8 border-t border-gray-200 pt-6">
                                <blockquote>
                                    <div>
                                        <p class="text-base text-gray-500"> &ldquo;{{ branding_01.testimonials[0].description }}&rdquo; </p>
                                    </div>
                                    <footer class="mt-3">
                                        <div class="flex items-center space-x-3">
                                            <div class="flex-shrink-0">
                                                <img class="h-6 w-6 rounded-full" :src="branding_01.testimonials[0].photo" alt="" />
                                            </div>
                                            <div class="text-base font-medium text-gray-700"> {{ branding_01.testimonials[0].personality }} </div>
                                        </div>
                                    </footer>
                                </blockquote>
                            </div>
                        ...
                        <div class="mt-12 sm:mt-16 lg:mt-0">
                            <div class="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                                <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none" :src="branding_01.photo?? branding_01.photo_default" alt="Inbox user interface" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                        <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                            <div>
                                ...
                                <div class="mt-6">
                                    <h2 class="text-3xl font-extrabold tracking-tight text-gray-900"> {{ branding_02.name }} </h2>
                                    <p class="mt-4 text-lg text-gray-500"> {{ branding_02.description }} </p>
                                    <div class="mt-6">
                                        <a :href="branding_02.href" :target="branding_02.name" class="inline-flex bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700">
                                            Get started
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="mt-12 sm:mt-16 lg:mt-0 lg:col-start-1">
                            <div class="pr-4 -ml-48 sm:pr-6 md:-ml-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                                <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none" :src="branding_02.photo?? branding_02.photo_default" alt="Customer profile user interface" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-purple-800 to-indigo-700">
                <div class="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
                    <h2 class="text-3xl font-extrabold text-white tracking-tight">What and How we provide...</h2>
                    <p class="mt-4 max-w-full text-lg text-purple-200">
