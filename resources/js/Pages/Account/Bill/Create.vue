        ...
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg">
                <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                    <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">Bill Create</p>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex items-center py-2 gap-4">
                                    <label v-for="vat_type in vat_types" :key="vat_type.id" class="mr-4 inline-flex items-center">
                                        <input v-model="form.job.vat_type" :value="vat_type.id" @update="form.vat_type" disabled type="radio" class="form-radio w-5 h-5 border-primary-500 text-primary-500 cursor-pointer focus:ring-primary-500">
...
export default {
    ...
    setup () {
        ...
        const form = reactive({
            client: { id: '', name: '', jobs: { id: '', name: '', vat_rate: null, vat_type: null } },
            job: { id: '', name: '', vat_rate: null, vat_type: null },
            date: null,
            number: null,
            remark: null,
            amount: null,
        ...
        function submit() {
            Inertia.post(route('bill.store'), form);
