            ...
            <div class="px-4 sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
                <div class="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                    ...
                    <div class="mt-6 h-9 flex space-x-3 md:mt-0 md:ml-4">
                        <Link :href="route('collection.create')" class="inline-flex items-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white hover:bg-gray-50 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-primary-400">
        ...
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg">
                <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                    <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">Collection Edit</p>

                    <div class="flex gap-4">
                        <ModelOptions :detailHref="route('collection.show', collection.id)" :editHref="null" :deleteHref="route('collection.destroy', collection.id)" deleteMessage="Do you really want to delete this order?" />
                    </div>
                </div>
                    ...
                    <dl class="space-y-8 divide-y divide-gray-200 py-6 max-w-3xl mx-auto">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <Select v-model="form.sector" :value="form.sector" :items="sectors" />
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input id="name" v-model="form.name" type="text" placeholder="Project Name" autocomplete="collection-name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="relative">
                                    <input id="amount" v-model="form.amount" type="text" placeholder="amount" autocomplete="collection-amount" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 pr-14 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="flex items-center py-2 gap-4">
                                    <label v-for="(vat_type, index) in vat_types" :key="index" class="mr-4 inline-flex items-center cursor-pointer">
                                        <input v-model="form.vat_type" type="radio" class="form-radio w-5 h-5 border-primary-500 text-primary-500 cursor-pointer focus:ring-primary-500">
...
export default {
    ...
    setup (props) {
        ...
        const form = reactive({
            sector: props.collection.sector,
            name: props.collection.name,
            amount: props.collection.amount,
            date: props.collection.date,
            remark: props.collection.remark,
        })

        function submit() {
            Inertia.patch(route('collection.update', props.collection.id), form)
        }
