        ...
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg">
                <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                    <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">Payment Create</p>
                    ...
                    <dl class="space-y-8 divide-y divide-gray-200 py-6 max-w-3xl mx-auto">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div v-show="form.payment_type == 'sector'" class="col-span-6 sm:col-span-3">
                                <label class="block text-sm font-medium text-gray-700"> Expense Sector <span class="text-rose-500">*</span> </label>
                                <Select v-model="form.sector" :items="sectors" creatable="Expense Sector" />
