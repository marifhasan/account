            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">Sector (Payment) Edit</p>
                        <div class="flex gap-4">
                            <ModelOptions :detailHref="null" :editHref="null" :deleteHref="route('sector.destroy', sector.id)" deleteMessage="Do you really want to delete this sector?" />
                        </div>
                    </div>
...
export default {
    ...
    setup (props) {
        ...
        function submit() {
            Inertia.patch(route('sector.update', props.sector.id), form)
        }
