            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">Asset Edit</p>
                        <div class="flex gap-4">
                            <ModelOptions :detailHref="route('asset.show', asset.id)" :editHref="null" :deleteHref="route('asset.destroy', asset.id)" deleteMessage="Do you really want to delete this asset?" />
                        </div>
                    </div>
...
export default {
    ...
    setup (props) {
        ...
        const form = reactive({
            ...
            is_fixed: props.asset.is_fixed? true : false,
            value: props.asset.value,
            type: props.asset.type_id,
            address: props.asset.address,
            remark: props.asset.remark,
            opening_check: props.asset.opening_check,
            opening_balance: props.asset.opening_balance,
            opening_date: props.asset.opening_date
        })

        function submit() {
            Inertia.patch(route('asset.update', props.asset.id), form)
        }
