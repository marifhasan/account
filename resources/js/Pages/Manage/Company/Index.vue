        ...
        <div class="py-5">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div
                        class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6"
                    >
                        <p
                            class="max-w-2xl leading-10 text-gray-700 text-lg font-medium"
                        >
                            Companies
                        </p>
                    ...
                    <table class="table-fixed min-w-full w-full" id="table">
                        <thead>
                            <tr>
                                <th
                                    class="px-5 py-3 border-b bg-gray-100 text-xs font-bold uppercase tracking-wider text-left w-10"
                                >
                                    S.No
                                </th>
                                <th
                                    class="px-5 py-3 border-b bg-gray-100 text-xs font-bold uppercase tracking-wider text-left"
                                >
                                    Name
                                </th>
                                <th
                                ...
                                <th
                                    class="px-5 py-3 border-b bg-gray-100 text-xs font-bold uppercase tracking-wider text-right"
                                >
                                    Action
                                </th>
                            </tr>
                        ...
                        <tbody class="bg-white">
                            ...
                            >
                                <td class="px-5 py-2 whitespace-no-wrap">
                                    <div
                                        class="text-sm leading-5 text-gray-700 text-center"
                                    >
                                        {{ index + 1 }}
                                    </div>
                                </td>
                                ...
                                <td
                                    class="px-5 py-2 whitespace-no-wrap text-sm leading-5 text-gray-600"
                                >
                                    <div
                                        class="text-sm leading-5 text-gray-700"
                                    >
                                ...
                                <td class="px-5 py-2 whitespace-no-wrap">
                                    <div class="flex justify-end">
                                        ...
                                        <button
                                            @click="deleteRecord(company.id)"
                                            class="text-rose-600 hover:text-rose-800 ml-3"
                                            title="delete"
                                        >
                                            <TrashIcon
                                                class="w-6 h-6"
    ...
    methods: {
        deleteRecord(record_id) {
            if (confirm("Do you really want to delete this company?")) {
                Inertia.delete(route("company.destroy", record_id));
            }
        },
    },
