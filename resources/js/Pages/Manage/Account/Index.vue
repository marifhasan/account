            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">Accounts</p>
                    ...
                    <table class="table-fixed min-w-full w-full" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="px-5 py-3 border-b bg-gray-100 text-xs font-bold uppercase tracking-wider text-left">Name / Address</th>
                                <th class="px-5 py-3 border-b bg-gray-100 text-xs font-bold uppercase tracking-wider text-left">Number / Branch</th>
                            ...
                            <tr v-for="(account, index) in accounts" :key="account.id" :class="[index % 2 == 0 ? 'bg-white' : 'bg-gray-50', 'border-b']">
                                ...
                                <td class="px-5 py-2 whitespace-no-wrap">
                                    <div class="flex justify-end">
                                        ...
                                        <button @click="deleteRecord(account.id)" class="text-rose-600 hover:text-rose-800 ml-3" title="delete">
    ...
    methods: {
        deleteRecord(record_id) {
            if(confirm("Do you really want to delete this account?")) {
                Inertia.delete(route('account.destroy', record_id));
            }
        }
    },
