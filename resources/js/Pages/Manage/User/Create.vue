            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium">User Create</p>
                            ...
                            <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-1">
                                    <div class="flex rounded shadow-sm">
                                        <input class="focus-within:z-10 focus:ring-primary-400 focus:border-primary-400 hover:bg-gray-100 focus:bg-transparent block w-full px-4 sm:text-sm border-gray-300 rounded-l" :type="password_invisible ? 'password' : 'text'" placeholder="Password" v-model="form.password" label="Password">
                                        <span class="inline-flex items-center justify-center px-4 rounded-r border border-l-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm">
                                            ...
                                            <EyeOffIcon v-show="password_invisible" @click="password_invisible = !password_invisible" class="w-5 h-5 cursor-pointer hover:text-rose-500" aria-hidden="true" />
                                        </span>
                                    </div>
